...
function delegate_self_validator() {
    ...
    initiad tx mstaking delegate $(initiad keys show wallet --bech val -a) ${mate}uinit --from $wallet_name --chain-id initiation-1 --gas-adjustment 1.4 --gas auto --gas-prices 0.15uinit --node $initiad_RPC_PORT -y
}
