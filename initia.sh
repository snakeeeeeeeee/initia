...
function delegate_self_validator() {
    ...
    initiad tx mstaking delegate $(initiad keys show wallet --bech val -a) ${mate}uinit --from $wallet_name --chain-id initiation-1 --gas=2000000 --fees=300000uinit --node $initiad_RPC_PORT -y
}
